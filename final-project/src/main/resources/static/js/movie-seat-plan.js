$(async function() {
    ...
    `)
        for (let i = 0; i < rowSeats.length; i++) {
            ...
            //     <img src="images/movie/seat01.png" alt="seat">
            // </li>
            // <li class="single-seat seat-free">
            //     <img src="images/movie/seat01-free.png" alt="seat">
            ...
            if (seatFree) {
                ...
                item.find("img").attr("src", "images/movie/seat01-free.png")
            }
            else
    ...
    $('.seat-area').on("click", ".seat-free", function (e) {
        ...
        if (isBooked) 
            div.find("img").attr("src", "images/movie/seat01-free.png")
        else
            div.find("img").attr("src", "images/movie/seat01-booked.png")
