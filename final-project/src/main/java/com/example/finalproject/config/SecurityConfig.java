...
import com.example.finalproject.security.AuthTokenFilter;
import com.example.finalproject.security.AuthenticationEntryPointJwt;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/users", "/api/v1/users/{id}").hasAnyAuthority(Roles.MEMBER.toString(), Roles.ADMIN.toString())
